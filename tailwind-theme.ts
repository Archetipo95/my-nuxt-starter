...
export default {
  ...
  'family:dropdown': {
    ...
    inner:
      'relative flex ring-1 ring-neutral-black focus-within:ring-[blue]/50 focus-within:ring-2 formkit-disabled:focus-within:ring-[grey] formkit-disabled:focus-within:ring-1 [&>span:first-child]:focus-within:text-[blue]/50 ring-inset',
    input: 'w-full',
    listbox: 'bg-neutral-white overflow-hidden',
    listboxButton: 'flex w-12 self-stretch justify-center mx-auto',
    listitem:
      'pl-7 relative hover:bg-[grey]/30 data-[is-active="true"]:bg-[grey]/30 aria-selected:bg-[blue]/60 aria-selected:text-neutral-white data-[is-active="true"]:aria-selected:bg-[blue]/60 data-[is-active="true"]:aria-selected:bg-[blue]/70',
    loaderIcon: 'hidden',
    ...
    placeholder: '',
    selector:
      'relative flex w-full items-baseline min-h-[2.625em] [&u] cursor-pointer p-4 pr-2 gap-1 focus-visible:outline-0',
    selection:
      'flex w-full [&>.formkit-option]:p-0 text-light-6 md:text-light-5',
    selectedIcon: 'hidden',
    selectIcon:
      'flex box-content h-5 w-5 cursor-pointer absolute top-1/2 right-2 -translate-y-1/2',
    wrapper: 'relative',
    label: 'text-medium-6 md:text-medium-5',
  },
  'family:text': {
    inner: 'flex items-center max-w-md border-b ',
    input: 'w-full pl-2 border-none text-book-6 placeholder-[grey] pb-2 pt-5',
    label: 'pl-2 font-light',
    messages: 'absolute pb-xs top-full left-0 right-0 ',
    message: 'pl-2 text-light-8 !mb-0 mb-sm',
    outer:
